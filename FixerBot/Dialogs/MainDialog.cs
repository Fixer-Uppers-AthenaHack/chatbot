...
namespace FixerBot.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        public MainDialog(FlightBookingRecognizer luisRecognizer, BookingDialog bookingDialog, FixerDialog fixerDialog, ILogger<MainDialog> logger)
        ...
        private async Task<DialogTurnResult> IntroStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            var messageText = stepContext.Options?.ToString() ?? $"What can I help you fix today?\nSay something like \"I want to fix my bike\"";
